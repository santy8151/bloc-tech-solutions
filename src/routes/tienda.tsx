...
import { ShoppingCart, CreditCard, ShieldCheck, Truck, ArrowRight, Check, Wifi, Camera, Network, Phone, Printer, HardDrive, BatteryCharging, Shield, type LucideIcon } from "lucide-react";
...
export const Route = createFileRoute("/tienda")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Tienda de equipos de telecomunicaciones, cámaras CCTV, routers, switches e impresoras con pago seguro desde nuestra app." },
...
const products: Product[] = [
  { id: "1", name: "Router WiFi 6 AX3000 Dual Band", category: "Conectividad", price: 459000 },
  { id: "2", name: "Cámara IP CCTV 4K con visión nocturna", category: "Seguridad", price: 329000 },
  { id: "3", name: "Switch Gigabit 24 puertos administrable", category: "Redes", price: 1299000 },
  { id: "4", name: "Teléfono IP empresarial pantalla color", category: "Telefonía IP", price: 389000 },
  { id: "5", name: "Impresora multifuncional láser color", category: "Periféricos", price: 1490000 },
  { id: "6", name: "NVR 8 canales + 4 cámaras kit completo", category: "Seguridad", price: 1899000 },
  { id: "7", name: "Access Point WiFi 6 PoE empresarial", category: "Conectividad", price: 549000 },
  { id: "8", name: "UPS 1500VA regulador para servidores", category: "Energía", price: 729000 },
  { id: "9", name: "Router Mesh WiFi 6 Tri-Band 3-pack", category: "Conectividad", price: 1199000 },
  { id: "10", name: "Cámara PTZ exterior 4K zoom 30x", category: "Seguridad", price: 2490000 },
  { id: "11", name: "Switch PoE+ 48 puertos Gigabit", category: "Redes", price: 3290000 },
  { id: "12", name: "Diadema inalámbrica Bluetooth con micrófono", category: "Telefonía IP", price: 459000 },
  { id: "13", name: "Impresora térmica de etiquetas y código QR", category: "Periféricos", price: 689000 },
  { id: "14", name: "Scanner documental dúplex 60ppm", category: "Periféricos", price: 1390000 },
  { id: "15", name: "Disco duro NAS 8TB Enterprise", category: "Almacenamiento", price: 1090000 },
  { id: "16", name: "NAS 2 bahías para respaldo empresarial", category: "Almacenamiento", price: 1790000 },
  { id: "17", name: "Firewall UTM SMB con licencia 1 año", category: "Seguridad", price: 2890000 },
  { id: "18", name: "Patch panel Cat6A 24 puertos blindado", category: "Redes", price: 549000 },
  { id: "19", name: "Lector biométrico de huella y RFID", category: "Seguridad", price: 459000 },
  { id: "20", name: "Proyector láser 4K para sala de juntas", category: "Periféricos", price: 4290000 },
  { id: "21", name: "Pantalla interactiva 65\" para reuniones", category: "Periféricos", price: 7890000 },
  { id: "22", name: "Regleta inteligente WiFi con monitoreo", category: "Energía", price: 219000 },
  { id: "23", name: "UPS online 3KVA doble conversión", category: "Energía", price: 3590000 },
  { id: "24", name: "Kit videoconferencia 4K USB plug & play", category: "Telefonía IP", price: 2190000 },
];
